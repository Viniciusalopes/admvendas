 ...
 * Finalidade: Fornecer o código html de componentes
 * ------------------------------------------------------------------------------------------
 */

function head($title = 'AdmVendas', $nivel = '..') {
    ?>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?php echo $nivel ?>/css/estilo.css?<?php echo rand() ?>">
